...
# @Last Modified time: 2017-06-12 22:05:53
# 
"""pressed glass carbon synthised in 

[1] M. Hu, J. He, Z. Zhao, T. A. Strobel, W. Hu, D. Yu, H. Sun, L. Liu, Z. Li, M. Ma, Y. Kono, J. Shu, H.-K. Mao, Y. Fei, G. Shen, Y. Wang, S. J. Juhl, J. Y. Huang, Z. Liu, B. Xu, and Y. Tian, 
“Compressed glassy carbon: An ultrastrong and elastic interpenetrating graphene network,”
 no. June, pp. 1–8, 2017.

and discripted in http://mp.weixin.qq.com/s?__biz=MzAwNzU5NjY5MA==&mid=2658343029&idx=1&sn=b5f48fbb3a8ced653770bcbd6587b21b&chksm=80fc0788b78b8e9e74c1e112946532d0f58ba14cffa8848e64144564d7d1d1f05fe57609d882&mpshare=1&scene=1&srcid=0612FlqVOY1vYShoZDxFcd6H#rd

the structure can be build as follows:
1. build a ziggag graphene block with 2x1x1 unit
2. find the rightest atoms as rotation center, copy and rotate the block along y axis with -120 
"""
...
class structure(Material):
	...
	def lmp_structure(self):
		atoms=Atoms()
		unit=graphene(dict(latx=2,laty=1,latz=1,gnrtype='zigzag')).lmp_structure()		
