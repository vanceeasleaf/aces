...
def Unit(srcUnits,type):
	...
	global ar_mass;
	global     kelvin;
	if type=='l':return angstrom[units]/angstrom[srcUnits];
	if type=="t":return femtosecond[units]/femtosecond[srcUnits];
	if type=="T":return kelvin[units]/kelvin[srcUnits];
	if type=="M":return ar_mass[units]/ar_mass[srcUnits];
	if type=="E":return (boltz[units]*kelvin[units])/(boltz[srcUnits]*kelvin[srcUnits]);
